...
| Paths and upgrades | Spaces, Unicode, file collisions, repeat install, stale-file removal, unrelated-skill preservation, source parity, source-alias rejection | Deterministic temporary directories only |
