...
| Paths and upgrades | Spaces, Unicode, file collisions, repeat install, failed-copy retention, stale-file removal, unrelated-skill preservation, source parity, and source/destination aliases | POSIX canonicalizes aliases; Windows rejects reparse and substituted-drive aliases; deterministic temporary directories only |
...
Executable commit `ae28aa6` passed [CI run
29311624165](https://github.com/George930502/curated-codex-skills/actions/runs/29311624165)
and [CodeQL run
29311624171](https://github.com/George930502/curated-codex-skills/actions/runs/29311624171).
